...
class Color {
	...
	setStyle( style, colorSpace = SRGBColorSpace ) {
		...
		function handleAlpha( string ) {
			...
			if ( parseFloat( string ) < 1 ) {
				...
				console.warn( 'FOUR.Color: Alpha component of ' + style + ' will be ignored.' );
		...
		if ( m = /^(\w+)\(([^\)]*)\)/.exec( style ) ) {
			...
			switch ( name ) {
				...
				default:
					...
					console.warn( 'FOUR.Color: Unknown color model ' + style );
			...
			if ( size === 3 ) {
				...
				console.warn( 'FOUR.Color: Invalid hex color ' + style );
	...
	setColorName( style, colorSpace = SRGBColorSpace ) {
		...
		if ( hex !== undefined ) {
			...
			// unknown color
			console.warn( 'FOUR.Color: Unknown color ' + style );
